...
const total_diffs = 6 #Total number of difference in this level
...
#A function that checks if a difference was found or not, and increases HP by 1. To make up for the function above (_on_Area2D7_input_event) reducing HP by 1 when finding a difference.
